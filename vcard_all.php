...
if(isset($_GET['u'])) {
    ...
    function exportContactVCF($c_id, $dbc, $user_id){
        ...
        $result = $dbc->query("SELECT `c_id`, `c_fname`, `c_lname`, `c_mname`, `c_email`, `c_phone`, `c_organization`, `c_jobTitle`, `c_workPhone`, `c_profile_pic` FROM `contacts_8521` WHERE `added_by_u_id` = $user_id AND `is_deleted_contact` = 0");
